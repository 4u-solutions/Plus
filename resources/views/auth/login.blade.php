        ...
        <div class="embed-responsive embed-responsive-1by1">
            <div class="embed-responsive-item h-100">
                <div class="row align-items-center h-100">
                    <div class="col-10 col-sm-3 mx-auto p-0 bg-white text-center shadow">
                        <div class="card-body">
                            ...
                            <form class="auth-login-form mt-2" action="" method="POST">
                                @csrf                               
                                <div class="mb-1">
                                    <input type="text" class="form-control" id="usersys" name="usersys" placeholder="Usuario" tabindex="1" autofocus required />
                                </div>

                                <div class="mb-1">
                                    <div class="input-group input-group-merge form-password-toggle">
                                        <input type="password" class="form-control form-control-merge" id="password" name="password" tabindex="2" placeholder="Contraseña" required />
